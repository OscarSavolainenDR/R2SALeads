...
import { apiGetSalesProducts, apiUnsubscribeCity, apiAddCityToBasket, apiStripeCheckout } from 'services/SubscribeService'
...
export const stripeCheckout = async (data) => {
    const response = await apiStripeCheckout(data)
    return response
}
