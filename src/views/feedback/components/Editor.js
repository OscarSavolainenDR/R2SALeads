...
// import { apiPostFeedback } from 'services/FeedbackService'
...
// const demoText = "<p>Let us know how we're doing! </p>"
...
// 		const resp = await apiPostFeedback(newData)
// 		setSubmitting(false)
// 		if (resp.data) {
// 			toast.push(
// 				<Notification 
...
// 						<FormContainer>
// 							<FormItem
// 								label="Let us know how we're doing!"
// 								className="mb-0"
...
// 								<Button type="submit" loading={isSubmitting} variant="solid">Submit</Button>				
// 							</div>
// 						</FormContainer>
// 					}
...
const Editor = ({mode}) => {
	...
	const [categoryList, setCategoryList] = useState(
		[
            { label: 'Desired Cities', value: 'cities' },
            { label: 'Improved Functionality', value: 'functionality' },
